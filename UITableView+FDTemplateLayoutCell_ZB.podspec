...
Pod::Spec.new do |s|
  s.name         = "UITableView+FDTemplateLayoutCell_ZB"
  s.version      = "1.8"
  ...
  s.homepage     = "https://github.com/ZBHome/UITableView-FDTemplateLayoutCell"
  ...
  s.platform = :ios, "6.0"
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.source = { :git => "https://github.com/ZBHome/UITableView-FDTemplateLayoutCell.git", :tag => s.version.to_s }
  # ――― Source Code ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
